            ...
            $querydata = mysqli_query($konek, $query)or die(mysqli_error($konek));
                      ...
                      else
                    {
                      ...
                      while($data = mysqli_fetch_array($querydata)){
                        ...
                        echo '<td  width="20"><center><a data-toggle="tooltip" data-placement="left" title="Edit Kelas" href=tu.php?content=edit-naik-kelas&&kode_daftar='.$data['kode_daftar'].'><i class="fa fa-edit fa-fw"></i></a></center></td>';
                        echo '</tr>';
                        $no++;
                      }
                    }
