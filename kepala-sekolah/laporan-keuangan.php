        ...
        <input type="hidden" name="id_pembayaran" value="<?php echo $id_pembayaran?>">
          ...
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              ...
              <p align="right">
                <button type="submit" formaction="kepsek.php?content=detail-pendaftaran" class="btn btn-primary">Detail Transaksi</button>
        ...
        <input type="hidden" name="id_pembayaran" value="<?php echo $id_pembayaran?>">
          ...
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              ...
              <p align="right">
                <button type="submit" formaction="kepsek.php?content=detail-transaksi-cicilan" class="btn btn-primary">Detail Transaksi</button>
                <button type="submit" formaction="#" class="btn btn-success"><i class='fa fa-print fa-fw'></i> Print</button></p>
            </div>
          </div>
      </form> 
        ...
        <input type="hidden" name="id_pembayaran" value="<?php echo $id_pembayaran?>">
          ...
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              ...
              <p align="right">
                <button type="submit" formaction="kepsek.php?content=detail-transaksi-lunas" class="btn btn-primary">Detail Transaksi</button>
                <button type="submit" formaction="#" class="btn btn-success"><i class='fa fa-print fa-fw'></i> Print</button></p>
            </div>
          </div>
      </form> 
        ...
        <input type="hidden" name="id_pembayaran" value="<?php echo $id_pembayaran?>">
          ...
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              ...
              <p align="right">
                <button type="submit" formaction="kepsek.php?content=detail-daftar-ulang" class="btn btn-primary">Detail Transaksi</button>
                <button type="submit" formaction="#" class="btn btn-success"><i class='fa fa-print fa-fw'></i> Print</button></p>
            </div>
          </div>
      </form> 
