...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2018 at 10:15 AM
...
(1, '2018 / 2019', '100000', '1500000', '200000', '250000', '76000', '92000', '45000', '93000', '54000', '15000', '10000', '15000', '200000', '200000', '200000', '3050000');
...
CREATE TABLE `tbl_pembayaran` (
  ...
  `b_pangkal_cicil` int(10) NOT NULL,
  `bukti_pangkal_cicil` varchar(50) NOT NULL,
  `validasi_pangkal_cicil` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_pembayaran` (`id_pembayaran`, `kode_daftar`, `b_daftar`, `bukti_daftar`, `validasi_daftar`, `b_pangkal_lunas`, `bukti_pangkal_lunas`, `validasi_pangkal_lunas`, `b_pangkal_cicil`, `bukti_pangkal_cicil`, `validasi_pangkal_cicil`) VALUES
(30, 3227, 0, '', 0, 0, '', 0, 0, '', 0);
...
(4, 'Erma Noviana', 'ermaerman', 'c002a6152f9256b2b38fcbceec1348a2', 'tatausaha');
...
--
ALTER TABLE `tbl_data_calon_murid`
  MODIFY `id_calon_murid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `tbl_pembayaran`
  MODIFY `id_pembayaran` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
