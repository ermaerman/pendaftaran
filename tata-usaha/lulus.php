...
<div class="col-md-10" style="padding:0px">
    <ol class="breadcrumb" style="margin:0;border-radius:0;">
        <li class="active"><a href="#">Kelas</a> / Lulus</li>
    </ol>
</div>
            ...
            $querydata = mysqli_query($konek, $query)or die(mysqli_error($konek));
                      ...
                      else
                    {
                      ...
                      while($data = mysqli_fetch_array($querydata)){
                        ...
                        echo '<td  width="20"><center><a data-toggle="tooltip" data-placement="left" title="Lulus" href=tu.php?content=edit-lulus&&kode_daftar='.$data['kode_daftar'].'><i class="fa fa-edit fa-fw"></i></a></center></td>';
                        echo '</tr>';
                        $no++;
                      }
                    }
