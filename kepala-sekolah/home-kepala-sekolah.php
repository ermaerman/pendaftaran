...
<div class="col-md-10" style="min-height:1600px;background:url(../gambar/blue2.jpg) no-repeat center center fixed;">
	...
	<p align="center">
		<?php
		echo "Hallo <b>".$_SESSION['nama']."</b>, selamat datang di halaman kepala sekolah <b>SMK Mandalahayu II Bekasi</b>.<br> Silahkan klik menu pilihan yang berada disebelah kiri untuk mengelola. Terimakasih."
		?>
	</p>
