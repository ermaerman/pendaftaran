<?php
  ...
  $edit    = "SELECT tbl_pembayaran.kode_daftar, tbl_pembayaran.id_pembayaran, tbl_pembayaran.validasi_pangkal_lunas, tbl_pembayaran.bukti_pangkal_lunas, tbl_data_calon_murid.nama FROM tbl_pembayaran, tbl_data_calon_murid WHERE tbl_pembayaran.id_pembayaran = '$id_pembayaran'";
        ...
        <input type="hidden" name="kode_daftar" value="<?php echo $data['kode_daftar'];?>">
            ...
            <div class="panel panel-primary">
              ...
              <tr>
                ...
                <td><i><font size="2px"><a data-toggle="tooltip" data-placement="right" title="Lihat Gambar" href="<?php echo $data['bukti_pangkal_lunas'] ?>" target="_blank"><?php echo $data['bukti_pangkal_lunas'] ?></a></font></i></td>
              </tr>
              <tr>
                <th><font size="2px">Status</font></th>
                <td><font size="2px"><i><?php if ($data['validasi_pangkal_lunas']==0) echo "Belum dikonfirmasi <i class='fa fa-times fa-fw'></i>"; else echo "Sudah dikonfirmasi <i class='fa fa-check fa-fw'></i>"; ?></i></font></td>
              </tr>
          </table>
          <p align="right">
