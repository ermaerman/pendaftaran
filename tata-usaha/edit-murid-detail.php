...
<div class="col-md-10" style="padding:0px">
  <ol class="breadcrumb" style="margin:0;border-radius:0;">
    <li class="active"><a href="tu.php?content=home-tata-usaha">Home</a> / Kelas / Kelas / Lihat Kelas Detail / Data Lengkap Murid</li>
  </ol>
</div>
...
<div class="col-md-10" style="min-height:500px">
  ...
  <p align="right"><a target ="_blank" role="button" href="print-data-murid-detail.php?id_calon_murid=<?php echo $data['id_calon_murid']; ?>"><button type="button" class="btn btn-success btn-md"><i class="fa fa-print fa-fw"></i> Print</button></a></p>
