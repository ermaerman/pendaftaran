...
<div class="col-md-10">
   ...
   <form class="form-inline" action="" method="POST">
      <div class="form-group">
        ...
        <a href="tu.php?content=data-murid"><button type="button" class="btn btn-warning"><i class="fa fa-refresh fa-fw"></i></button></a>
     ...
     if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        <div style="float:right;">
          <ul class="pagination pagination-sm" style="margin: 0">
            ...
            for ($i=1; $i <= $jml_hal; $i++) {
              if ($i != $hal) {
                echo "<li><a href=\"tu.php?content=data-murid&&hal=$i\">$i</a></li>";
              } else {
