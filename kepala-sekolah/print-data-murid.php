 ...
 <body onload="window.print()">
   <div class="panel-group">
      <div class="panel panel-primary">
        <div class="panel-heading"><p align="center"><b>Print Data Murid</b></p></div>
...
<?php
          error_reporting(0);
            ...
            $query = mysqli_query($konek, "SELECT * FROM tbl_data_calon_murid WHERE status='1' ORDER BY id_calon_murid DESC")or die(mysqli_error($konek));
