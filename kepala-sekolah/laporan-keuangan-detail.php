...
<div class="col-md-10" style="padding:0px">
  <ol class="breadcrumb" style="margin:0;border-radius:0;">
    <li class="active"><a href="tu.php?content=home-tata-usaha">Home</a> / <a href="#">Laporan</a> / Laporan Keuangan Detail</li>
  </ol>
</div>
...
<script type="text/javascript">
    ...
    $( "#tahun" ).change(function() {
      ...
      console.log(tahun);
      $.ajax({
        url: "../tata-usaha/ajax_total_uang_gedung.php?tahun_pelajaran=" + tahun_pelajaran,
        success: function(result){
            console.log(result);
...
<script type="text/javascript">
    ...
    $( "#tahun" ).change(function() {
      ...
      console.log(tahun);
      $.ajax({
        url: "../tata-usaha/ajax_total_biaya_mos.php?tahun_pelajaran=" + tahun_pelajaran,
        success: function(result){
            console.log(result);
...
<script type="text/javascript">
    ...
    $( "#tahun" ).change(function() {
      ...
      console.log(tahun);
      $.ajax({
        url: "../tata-usaha/ajax_total_biaya_spp.php?tahun_pelajaran=" + tahun_pelajaran,
        success: function(result){
            console.log(result);
...
<script type="text/javascript">
    ...
    $( "#tahun" ).change(function() {
      ...
      console.log(tahun);
      $.ajax({
        url: "../tata-usaha/ajax_total_seragam_putih_abu.php?tahun_pelajaran=" + tahun_pelajaran,
        success: function(result){
            console.log(result);
...
<script type="text/javascript">
    ...
    $( "#tahun" ).change(function() {
      ...
      console.log(tahun);
      $.ajax({
        url: "../tata-usaha/ajax_total_seragam_olahraga.php?tahun_pelajaran=" + tahun_pelajaran,
        success: function(result){
            console.log(result);
...
<script type="text/javascript">
    ...
    $( "#tahun" ).change(function() {
      ...
      console.log(tahun);
      $.ajax({
        url: "../tata-usaha/ajax_total_seragam_batik.php?tahun_pelajaran=" + tahun_pelajaran,
        success: function(result){
            console.log(result);
...
<script type="text/javascript">
    ...
    $( "#tahun" ).change(function() {
      ...
      console.log(tahun);
      $.ajax({
        url: "../tata-usaha/ajax_total_seragam_pramuka.php?tahun_pelajaran=" + tahun_pelajaran,
        success: function(result){
            console.log(result);
...
<script type="text/javascript">
    ...
    $( "#tahun" ).change(function() {
      ...
      console.log(tahun);
      $.ajax({
        url: "../tata-usaha/ajax_total_baju_muslim.php?tahun_pelajaran=" + tahun_pelajaran,
        success: function(result){
            console.log(result);
...
<script type="text/javascript">
    ...
    $( "#tahun" ).change(function() {
      ...
      console.log(tahun);
      $.ajax({
        url: "../tata-usaha/ajax_total_topi.php?tahun_pelajaran=" + tahun_pelajaran,
        success: function(result){
            console.log(result);
...
<script type="text/javascript">
    ...
    $( "#tahun" ).change(function() {
      ...
      console.log(tahun);
      $.ajax({
        url: "../tata-usaha/ajax_total_dasi.php?tahun_pelajaran=" + tahun_pelajaran,
        success: function(result){
            console.log(result);
...
<script type="text/javascript">
    ...
    $( "#tahun" ).change(function() {
      ...
      console.log(tahun);
      $.ajax({
        url: "../tata-usaha/ajax_total_ikat_pinggang.php?tahun_pelajaran=" + tahun_pelajaran,
        success: function(result){
            console.log(result);
...
<script type="text/javascript">
    ...
    $( "#tahun" ).change(function() {
      ...
      console.log(tahun);
      $.ajax({
        url: "../tata-usaha/ajax_total_kbm_pramuka.php?tahun_pelajaran=" + tahun_pelajaran,
        success: function(result){
            console.log(result);
...
<script type="text/javascript">
    ...
    $( "#tahun" ).change(function() {
      ...
      console.log(tahun);
      $.ajax({
        url: "../tata-usaha/ajax_total_kbm_praktek.php?tahun_pelajaran=" + tahun_pelajaran,
        success: function(result){
            console.log(result);
...
<script type="text/javascript">
    ...
    $( "#tahun" ).change(function() {
      ...
      console.log(tahun);
      $.ajax({
        url: "../tata-usaha/ajax_total_lks.php?tahun_pelajaran=" + tahun_pelajaran,
        success: function(result){
            console.log(result);
          $("#totallks").val(result);
        }
...
<script type="text/javascript">
    ...
    $( "#tahun" ).change(function() {
      ...
      console.log(tahun);
      $.ajax({
        url: "../tata-usaha/ajax_total_lunas.php?tahun_pelajaran=" + tahun_pelajaran,
        success: function(result){
            console.log(result);
