...
<div class="col-md-10" style="padding:0px">
  <ol class="breadcrumb" style="margin:0;border-radius:0;">
    <li class="active"><a href="tu.php?content=home-tata-usaha">Home</a> / <a href="tu.php?content=data-calon-murid">Data Calon Murid</a> / Data Lengkap Calon Murid</li>
  </ol>
</div>
