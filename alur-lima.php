...
<br>
  <table>
        <tr>
        <td><p align="justify"><i>Klik pada link <font color="blue">disini</font> untuk melihat tanggal ujian.</i></p></td>
    	</tr>
</table><br>

  <div class="col-md-12">
    <div class="thumbnail">
        <img src="gambar/alurlima.png" alt="Lights" style="width:100%">
        <div class="caption">
  ...
  <ul class="pagination">
    ...
    <li class="active"><a href="index.php?content=alur-lima">5</a></li>
