...
<br>
  <table>
        <tr>
        <td><p align="justify"><i>Jika lulus, silahkan input ukuran baju anda. Perhatian bagi yang tidak lulus, uang administrasi pendaftaran tidak dapat dikembalikan.</i></p></td>
    	</tr>
</table><br>

  <div class="col-md-12">
    <div class="thumbnail">
        <img src="gambar/alurdelapan.png" alt="Lights" style="width:100%">
        <div class="caption">
  ...
  <ul class="pagination">
    ...
    <li class="active"><a href="index.php?content=alur-delapan">8</a></li>
