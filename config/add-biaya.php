<?php
	...
	$insert			= "INSERT INTO tbl_biaya VALUES ('','$tahun_pelajaran','$biaya_pendaftaran','$uang_gedung','$biaya_mos', '$biaya_spp','$seragam_putih_abu','$seragam_olahraga','$seragam_batik','$seragam_pramuka','$baju_muslim','$topi','$dasi','$ikat_pinggang','$kbm_pramuka','$kbm_praktek','$kbm_ekstra','$total_pangkal','$daftar_ulang1','$daftar_ulang2')";
