    ...
    $query = mysqli_query($konek,"SELECT * FROM tbl_pembayaran WHERE kode_daftar = '$kode_daftar'")or die(mysqli_error($konek));
      if(mysqli_num_rows($query) == 0){
        ...
        $data = mysqli_fetch_array($query);
          ...
          if ($data['b_daftar']==0 AND $data['validasi_daftar']==0 AND $data['b_pangkal_lunas']==0 AND $data['validasi_pangkal_lunas']==0 AND $data['b_pangkal_cicil1']==0 AND $data['validasi_pangkal_cicil1']==0 AND $data['b_pangkal_cicil2']==0 AND $data['validasi_pangkal_cicil2']==0 AND $data['b_pangkal_cicil3']==0 AND $data['validasi_pangkal_cicil3']==0) {
          ...
          elseif ($data['b_daftar']==1 AND $data['validasi_daftar']==0 AND $data['b_pangkal_lunas']==0 AND $data['validasi_pangkal_lunas']==0 AND $data['b_pangkal_cicil1']==0 AND $data['validasi_pangkal_cicil1']==0 AND $data['b_pangkal_cicil2']==0 AND $data['validasi_pangkal_cicil2']==0 AND $data['b_pangkal_cicil3']==0 AND $data['validasi_pangkal_cicil3']==0) {
              echo "<h2>Cek Proses</h2><hr>";
          ...
          elseif ($data['b_daftar']==1 AND $data['validasi_daftar']==1 AND $data['b_pangkal_lunas']==0 AND $data['validasi_pangkal_lunas']==0 AND $data['b_pangkal_cicil1']==0 AND $data['validasi_pangkal_cicil1']==0 AND $data['b_pangkal_cicil2']==0 AND $data['validasi_pangkal_cicil2']==0 AND $data['b_pangkal_cicil3']==0 AND $data['validasi_pangkal_cicil3']==0) {
              echo "<h2>Cek Proses</h2><hr>";
          ...
          elseif ($data['b_daftar']==1 AND $data['validasi_daftar']==1 AND $data['b_pangkal_lunas']==1 AND $data['validasi_pangkal_lunas']==0 AND $data['b_pangkal_cicil1']==0 AND $data['validasi_pangkal_cicil1']==0 AND $data['b_pangkal_cicil2']==0 AND $data['validasi_pangkal_cicil2']==0 AND $data['b_pangkal_cicil3']==0 AND $data['validasi_pangkal_cicil3']==0) {
              echo "<h2>Cek Proses</h2><hr>";
              echo "<i>Anda sudah membayar biaya uang pangkal lunas tetapi pembayaran belum dikonfirmasi oleh tata usaha kami.</i><br>";
              echo "<i>Silahkan tunggu beberapa saat lagi sampai dikonfirmasi oleh tatausaha kami. Kemudian cek proses kembali.</i>";
          }
          elseif ($data['b_daftar']==1 AND $data['validasi_daftar']==1 AND $data['b_pangkal_lunas']==1 AND $data['validasi_pangkal_lunas']==1 AND $data['b_pangkal_cicil1']==0 AND $data['validasi_pangkal_cicil1']==0 AND $data['b_pangkal_cicil2']==0 AND $data['validasi_pangkal_cicil2']==0 AND $data['b_pangkal_cicil3']==0 AND $data['validasi_pangkal_cicil3']==0) {
              echo "<h2>Cek Proses</h2><hr>";
          ...
          elseif ($data['b_daftar']==1 AND $data['validasi_daftar']==1 AND $data['b_pangkal_lunas']==0 AND $data['validasi_pangkal_lunas']==0 AND $data['b_pangkal_cicil1']==1 AND $data['validasi_pangkal_cicil1']==0 AND $data['b_pangkal_cicil2']==0 AND $data['validasi_pangkal_cicil2']==0 AND $data['b_pangkal_cicil3']==0 AND $data['validasi_pangkal_cicil3']==0) {
              echo "<h2>Cek Proses</h2><hr>";
          ...
          elseif ($data['b_daftar']==1 AND $data['validasi_daftar']==1 AND $data['b_pangkal_lunas']==0 AND $data['validasi_pangkal_lunas']==0 AND $data['b_pangkal_cicil1']==1 AND $data['validasi_pangkal_cicil1']==1 AND $data['b_pangkal_cicil2']==0 AND $data['validasi_pangkal_cicil2']==0 AND $data['b_pangkal_cicil3']==0 AND $data['validasi_pangkal_cicil3']==0) {
              echo "<h2>Cek Proses</h2><hr>";
          ...
          elseif ($data['b_daftar']==1 AND $data['validasi_daftar']==1 AND $data['b_pangkal_lunas']==0 AND $data['validasi_pangkal_lunas']==0 AND $data['b_pangkal_cicil1']==1 AND $data['validasi_pangkal_cicil1']==1 AND $data['b_pangkal_cicil2']==1 AND $data['validasi_pangkal_cicil2']==0 AND $data['b_pangkal_cicil3']==0 AND $data['validasi_pangkal_cicil3']==0) {
              echo "<h2>Cek Proses</h2><hr>";
          ...
          elseif ($data['b_daftar']==1 AND $data['validasi_daftar']==1 AND $data['b_pangkal_lunas']==0 AND $data['validasi_pangkal_lunas']==0 AND $data['b_pangkal_cicil1']==1 AND $data['validasi_pangkal_cicil1']==1 AND $data['b_pangkal_cicil2']==1 AND $data['validasi_pangkal_cicil2']==1 AND $data['b_pangkal_cicil3']==0 AND $data['validasi_pangkal_cicil3']==0) {
              echo "<h2>Cek Proses</h2><hr>";
           ...
           elseif ($data['b_daftar']==1 AND $data['validasi_daftar']==1 AND $data['b_pangkal_lunas']==0 AND $data['validasi_pangkal_lunas']==0 AND $data['b_pangkal_cicil1']==1 AND $data['validasi_pangkal_cicil1']==1 AND $data['b_pangkal_cicil2']==1 AND $data['validasi_pangkal_cicil2']==1 AND $data['b_pangkal_cicil3']==1 AND $data['validasi_pangkal_cicil3']==0) {
              echo "<h2>Cek Proses</h2><hr>";
